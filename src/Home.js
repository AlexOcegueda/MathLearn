    ...
    return (
        ...
        <>
            <div className='begin-banner-container'>
                <p className='begin-banner-text'>Get Started Right Away Here!</p>
                <button className='begin-banner-btn'>Begin</button>
            </div>
            <div className='content-1-container'>
                <h1 className='content-1-header'>About Us</h1>
